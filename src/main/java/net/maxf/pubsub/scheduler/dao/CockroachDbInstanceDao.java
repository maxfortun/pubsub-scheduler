...
@ApplicationScoped
@CockroachDb
public class CockroachDbInstanceDao implements InstanceDao {

    private static final Logger LOG = Logger.getLogger(CockroachDbInstanceDao.class);
    ...
    public void upsert(String instanceId, Instant heartbeatAt, Instant startedAt) {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            LOG.errorf(e, "Failed to upsert instance %s", instanceId);
    ...
    public void delete(String instanceId) {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            LOG.warnf(e, "Failed to delete instance %s", instanceId);
    ...
    public Optional<InstanceInfo> findById(String instanceId) {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            LOG.errorf(e, "Failed to find instance %s", instanceId);
